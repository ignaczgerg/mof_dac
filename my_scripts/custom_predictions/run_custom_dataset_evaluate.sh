...
python custom_dataset_evaluate.py \
  --ckpt /ibex/project/c2261/dac_iclr/finetune/lightning_logs/lt9kpqrn/aramco_dac_finetune/lt9kpqrn/checkpoints/last.ckpt \
  --task_name external_eval \
  --test_src /ibex/project/c2261/datasets/all-adsorption/mof_db_anion/lmdb/train/ \
  --predict_only \
  --suffix "_anion" \
  --num_workers 6 \
