...
class GOCBackboneConfig(TypedConfig):
    name: Literal["gemnetoc", "GemNet-OC", 
                  "GemNetOC", "gemnet-oc"] = "GemNet-OC"
    num_targets: int = 1
    num_spherical: int
    num_radial: int
    num_blocks: int
...
class BasesConfig(TypedConfig):
    ...
    @classmethod
    def from_backbone_config(cls, backbone_config: GOCBackboneConfig):
        return cls(
