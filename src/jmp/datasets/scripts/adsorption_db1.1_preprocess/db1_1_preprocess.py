...
LOGGER = logging.getLogger("db1-1-preprocess")
...
class DataLoader(object):
    def __init__(
        ...
        self.csv_path = os.path.join(base_folder, "db_1_merged.csv")
        ...
        self.properties = {
            "Qst_CO2_kJmol":"qst_co2",
            "KH_CO2_molkgPa":"kh_co2",
            "Qst_H2O_kJmol":"qst_h2o",
            "KH_H2O_molkgPa":"kh_h2o",
            # "Qst_N2_kJmol":"qst_n2",
            # "KH_N2_molkgPa":"kh_n2",
            "CO2_uptake_mmolg":"co2_uptake",
            # "N2_uptake_mmolg":"co2_uptake",
            # "LCD":"lcd",
            # "PLD":"pld",
            # "GCD":"gcd",
