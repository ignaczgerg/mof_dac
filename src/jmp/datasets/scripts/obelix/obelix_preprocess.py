...
class DataLoader(object):
    def __init__(
        ...
        self.cif_path = os.path.join(base_folder, "all_randomized_cifs")
        self.csv_path = os.path.join(base_folder, "obelix_cleaned.csv")
        ...
        self.properties = {
            'Ionic conductivity (S cm-1)': 'ionic_conductivity',
        }
