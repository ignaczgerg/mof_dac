...
python write_lmdb.py \
  --csv_paths /ibex/project/c2261/datasets/all-adsorption/DATABASES/MOF-DB-2.0/MOF-DB-2-merged.csv /ibex/project/c2261/datasets/all-adsorption/DATABASES/MOF-DB-2.0/MOF-DB-2.0-Geometrical-merged.csv \
  --cif_path /ibex/project/c2261/datasets/all-adsorption/DATABASES/MOF-DB-2.0/CIF_FILES_V2_1_1 \
  --entity_key FrameworkName \
  --out_dir /ibex/project/c2261/datasets/all-adsorption/mof_db_2_charges/lmdb \
  --backend process \
  --num_workers 32 \
  --map_size_gb 16 \
  --ratio 94,2,4 \
