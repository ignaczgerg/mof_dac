...
python write_lmdb.py \
  --csv_paths /ibex/project/c2261/datasets/all-adsorption/DATABASES/MOF-DB-ANION/merged.csv \
  --cif_path /ibex/project/c2261/datasets/all-adsorption/DATABASES/MOF-DB-ANION/anion_pillars/ \
  --entity_key FrameworkName \
  --out_dir /ibex/project/c2261/datasets/all-adsorption/mof_db_anion_charges/lmdb \
  --backend process \
  --num_workers 32 \
  --map_size_gb 16 \
  --ratio 60,20,20 \
