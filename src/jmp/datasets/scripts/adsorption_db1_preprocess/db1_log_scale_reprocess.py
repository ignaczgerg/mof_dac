...
SRC_ROOTS = {
    "train": "/ibex/project/c2261/datasets/adsorption-mof-db1/lmdb/train",
    "val":   "/ibex/project/c2261/datasets/adsorption-mof-db1/lmdb/val",
    "test":  "/ibex/project/c2261/datasets/adsorption-mof-db1/lmdb/test",
}
DST_ROOTS = {
    "train": "/ibex/project/c2261/datasets/log-db1/lmdb/train",
    "val":   "/ibex/project/c2261/datasets/log-db1/lmdb/val",
    "test":  "/ibex/project/c2261/datasets/log-db1/lmdb/test",
}
...
def passes_predicate(dp) -> bool:
    try:
        ...
        selectivity_co2_n2,_=_get_attr(dp,'selectivity_co2_n2')
        ...
        selectivity_co2_n2=_to_float(selectivity_co2_n2)
        selectivity_co2_h2o=_to_float(selectivity_co2_h2o)
    except KeyError:
        return False
    return (
        (kh_co2  < 1.0) and (kh_n2 < 1.0) and (kh_h2o < 1.0) and
        (qst_co2 < 0.0) and (qst_h2o < 0.0) and (qst_n2  < 0.0) and
        (n2_uptake > 0.0) and (co2_uptake > 0.0) and (selectivity_co2_n2 > 0.0) and
