...
def hmof_config(
    ...
    elif args.dataset_name == "hmof-mini":
        lmdb_path = base_path / "lmdb_mini" / f"{split}"
        assert lmdb_path.exists(), f"{lmdb_path} does not exist"
...
def obelix_config(
    ...
    if args.dataset_name == "obelix":
        print(f"[info] using obelix dataset: {base_path}")
        lmdb_path = base_path / "lmdb" / f"{split}"
        assert lmdb_path.exists(), f"{lmdb_path} does not exist"
