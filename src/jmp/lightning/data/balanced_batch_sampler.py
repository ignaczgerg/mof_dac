...
class BalancedBatchSampler(BatchSampler):
    ...
    def __init__(
        ...
        *,
        batch_size: int,
        device: torch.device,
        drop_last: bool = True, # if this is set to False, it can oversample if 
                                # atom_batch_sampler is used. 
                                # if True, the dataset is probably undersampled
                                # but I think it is rather insignificant.
    ):
