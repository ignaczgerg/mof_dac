...
from ...models.EScAIP.config import EScAIPBackboneConfig
...
def escaip_small_ft_config_(
    ...
    config.model_cls = EScAIPModelWrapper
    ...
    if args.medium:
        config.backbone = EScAIPBackboneConfig.medium()
    elif args.large:
        config.backbone = EScAIPBackboneConfig.large()
    else:
        config.backbone = EScAIPBackboneConfig.small()
        # config.backbone = config.backbone.very_small()
    
   
    # Force equality of the following
