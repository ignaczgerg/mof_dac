...
def equiformer_v2_ft_config_(
    ...
    if not getattr(args, "scratch", False):
    ...
    # Charge embedding (per-atom partial charges early fusion)
    config.backbone.use_charge_embedding = getattr(args, "use_charge_embedding", False)
